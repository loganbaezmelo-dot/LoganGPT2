                ...
                <div className="space-y-4">
                  ...
                  <div className={`p-4 rounded-xl border relative overflow-hidden ${imagenKey ? 'border-indigo-500/50 bg-indigo-500/10' : 'border-white/10 bg-gradient-to-br from-indigo-900/20 to-purple-900/20'}`}>
                    <div className="flex justify-between items-center mb-3">
                      <h3 className="font-bold text-white flex items-center gap-2">
                        <ImageIcon className="w-4 h-4 text-indigo-400" /> Imagen Tier
                      </h3>
                      {imagenKey ? (
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Imagen API Key</label>
                      <input 
                        type="password" 
                        value={imagenKey} 
